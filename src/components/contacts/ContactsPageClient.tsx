...
export function ContactsPageClient() {
  ...
  return (
    <div className="container-site py-8">
      <Breadcrumbs items={[{ label: tr("contacts.title") }]} />
      <h1 className="mt-6 h-display text-3xl md:text-4xl">{tr("contacts.title")}</h1>
      <p className="mt-2 max-w-xl text-muted">{tr("contacts.subtitle")}</p>
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        <div className="card flex items-start gap-4 p-6">
          ...
          <div>
            <p className="text-xs uppercase tracking-wider text-faint">{tr("contacts.koreaPhone")}</p>
