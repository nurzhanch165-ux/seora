...
export const Whatsapp = (p: IconProps) => (
  <Base {...p}>
    <path d="M4 20l1.2-3.8A7.5 7.5 0 1 1 8 19.2L4 20Z" />
    <path d="M9 9.2c.2 2.4 2.4 4.6 4.8 4.8.6.05 1.1-.5 1.1-1.1v-.5l-1.6-.7-.8.8a4 4 0 0 1-1.9-1.9l.8-.8-.7-1.6h-.5c-.6 0-1.15.5-1.2 1.1Z" />
  </Base>
);
